...
(function (factory) {
    ...
    $h = {
        ...
        defaultButtonCss: function (fill) {
            ...
            return 'btn-default btn-' + (fill ? '' : '-') + 'primary';
        },
        now: function () {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            var modalClose = '<button type="button" class="btn btn-sm btn-kv btn-default btn--primary btn-kv-close" title="Close detailed preview" data-bs-dismiss="modal" aria-label="Close">'+
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '      <div class="kv-zoom-actions">{rotate}{toggleheader}{fullscreen}{borderless}'+/*{close}*/modalClose+'</div>\n' +
                '    </div>\n' +
            ...
            tProgress = '<div class="upload-progress">\n' +
        ...
        _loadRefreshedDataFromServer(pageSlug){
            
            switch(pageSlug){

                case 'chapter_curriculum':
                    countUpload++;
                    if(countUpload == fileCount){
                        ...
                        setTimeout(function(){
                            ...
                            $('html, body').animate({
                                scrollTop: $("#uploaded_curriculum_media").offset().top
                            }, 500);
                        },1000);
                        countUpload = 0;
                    }
        ...
        _resetCaption: function () {
            ...
            setTimeout(function () {
                ...
                self._loadRefreshedDataFromServer(pageSlug);
            }, self.processDelay);
        },
        ...
        _renderMain: function () {
            var self = this,
                ...
                caption = self.captionTemplate.setTokens({'class': css + ' kv-fileinput-caption inline-height'});
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            prev: 'btn btn-default btn-primary btn-navigate',
            next: 'btn btn-default btn-primary btn-navigate',
            rotate: defBtnCss1,
