                        ...
                        <div class="basic-form">
                            <form action="<?= admin_url('subject/updateChapter') ?>" class="form-horizontal forms-sample" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="chapterName" id="chapterName" autocomplete="off" value="<?= @$data->chapterName ?>" placeholder="Chapter Name" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="chapterNumber" id="chapterNumber" autocomplete="off" value="<?= @$data->chapterNumber?>"  placeholder="Chapter Number" readonly>
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Duration (In Hours)<span class="error">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="totalHours" id="totalHours" autocomplete="off" value="<?= @$data->totalHours?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Cost (In USD)<span class="error">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="cost" id="cost" autocomplete="off" value="<?= @$data->cost?>"  readonly>
                                    </div>
                                </div>
                                   <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Summary <span class="error">*</span></label>
                                    <div class="col-sm-9">                 
                                        <textarea name="summary" class="form-control" readonly><?= strip_tags(html_entity_decode($data->summary)) ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Objectives <span class="error">*</span> </label>
                                    <div class="col-sm-9">
                                        <textarea name="objectives" class="form-control" readonly><?= strip_tags(html_entity_decode($data->objectives)) ?></textarea>
                                    </div>
                                </div>
