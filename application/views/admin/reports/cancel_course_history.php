				...
				<div class="col-xl-6 col-lg-6 d-flex flex-wrap">
					<div class="ml-auto">
						<a href="<?= admin_url('reports/cancelcoursedata') ?>" class="btn btn-rounded btn-info">
							<span> <i class="fa fa-history color-info"></i></span> View Cancel Course Data 
						</a>	

						<?php if($status == 1){ ?> 
							<a href="<?= admin_url('reports/view-unapproved-course-cancel-data/inactive') ?>" class="btn btn-rounded btn-danger">
								<span> <i class="fa fa-list"></i></span> View Unapproved Data 
							</a>	
						<?php }else{ ?>		
						   <a href="<?= admin_url('reports/view-approved-course-cancel-data/active') ?>" class="btn btn-rounded btn-success">
										...
										?>
											<tr class="odd" role="row">
												...
												<td class="text-center actionbtnlist">
													<a href="<?=admin_url('reports/cancel-course-history/details/'.$v->requestId)?>" class="btn btn-xs btn-warning" data-toggle="tooltip2" title="View Details">
