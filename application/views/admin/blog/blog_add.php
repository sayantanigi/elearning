					...
					<div class="card">
						...
						<div class="card-body">
							<div class="basic-form">
								<form action="<?= admin_url('blog/create') ?>" class="form-horizontal forms-sample" method="post" enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<textarea name="descriptions" class="form-control summernote" required=""></textarea>
										</div>
									</div>
