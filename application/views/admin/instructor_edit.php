									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="origin_country" id="origin_country" value="<?= @$data->origin_country ?>" autocomplete="off" required>
											</div>
										</div>
	                                            ...
	                                            <div class="fileinput fileinput-new file-block" data-provides="fileinput">
	                                                ...
	                                                <div>
	                                                    <span class="btn btn-default btn-file">
	                                                        ...
	                                                        <input type="file" name="profilePic" accept="images/*" <?=(!empty($oldProfilePic)?'':'required')?>>
	                                                    </span>
	                                                    <input type="hidden" name="oldProfilePic" value="<?= @$oldProfilePic ?>">
...
<script>
    ...
    $(document).on('submit', '#update_instructor_form', function(event){
        ...
        if(accountNo != accountNoCnfrm){
             ...
             $.ajax({
              url:adminUrl+'instructors/update',
              method:'POST',
