<?php
  $watch_intro_title =  string_seperator(clean_String($cmsContent[0]->cmsTitle));

  if($cmsContent[0]->image && file_exists('./uploads/cms/'.$cmsContent[0]->image)) {
    $watch_intro_img = base_url('uploads/cms/'.$cmsContent[0]->image);
  }else{
    $watch_intro_img = base_url('frontend/images/about-us-hero-bg.jpg');
  }  
  $watch_intro_link = $cmsContent[0]->link;

  $help_title =  clean_String($cmsContent[1]->cmsTitle);
  $help_content =  clean_String($cmsContent[1]->content);
  $help_img = $cmsContent[1]->image;

  $join_team_title =  string_seperator(clean_String($cmsContent[2]->cmsTitle));
...
?>
        <!-- About Video Start -->
        <div class="about-video-section" style="background-image: url(<?=$watch_intro_img?>);">
            <div class="container custom-container">
                <div class="row gy-10 justify-content-between align-items-center">
                    <div class="col-xl-9 col-lg-8">

                        <!-- About Video Start -->
                        <div class="about-video-content" data-aos="fade-up" data-aos-duration="1000">
                            <h2 class="about-video-content__main-title"><strong><?=$watch_intro_title[0]?></strong> <?=$watch_intro_title[1]?> </h2>
                        </div>
                        <!-- About Video End -->
                    ...
                    <div class="col-xl-3 col-lg-4">
                        ...
                        <div class="video-play" data-aos="fade-up" data-aos-duration="1000">
                            <a href="<?=$watch_intro_link?>" class="glightbox">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="menu-content-banner" style="background-image: url(assets/images/home-megamenu-bg.jpg);">
                                                    <h4 class="menu-content-banner__title">Achieve Your Goals With E-Learning</h4>
        ...
        <div class="counter-section-02 bg-color-04 scene">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="counter-item-02">
                                ...
                                <div class="counter-item-02__content">
                                    <span class="counter-item-02__count count" data-count="<?=$stuData->stuCount?>"><?=$stuData->stuCount?></span>
                                    <p class="counter-item-02__text">Students Enrolled</p>
                                </div>
                            </div>
                            <!-- Counter Item End -->
                        ...
                        <div class="col-lg-4 col-sm-4" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="counter-item-02">
                                ...
                                <div class="counter-item-02__content">
                                    <span class="counter-item-02__count count"  data-count="<?=$courseData->courseCount?>"><?=$courseData->courseCount?></span>
                                    <p class="counter-item-02__text">Courses</p>
                                </div>
                            </div>
                            <!-- Counter Item End -->
                        ...
                        <div class="col-lg-4 col-sm-4" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="counter-item-02">
                                ...
                                <div class="counter-item-02__content">
                                    <span class="counter-item-02__count count" data-count="<?=count($insData)?>"><?=count($insData)?></span>
                                    <p class="counter-item-02__text">Instructors</p>
                                </div>
                            </div>
                            <!-- Counter Item End -->
            ...
            <img class="counter-section-02__shape-05" data-depth="-0.8" src="<?=base_url()?>frontend/images/shape/edumall-shape-01.png" alt="Shape" width="179" height="178">
        </div>
        <!-- Counter End -->

         <div class="row my-5">
            <div class="col-md-12 text-center">
                <a class="btn btn-primary btn-hover-secondary display_instructor_signup_modal" href="javascript:void(0);">Join Instructor Team</a>
            </div>
         </div>    

         <!-- Instructor Banner Start -->
        <div class="instructor-banner-02 mb-5">
            <div class="container custom-container">
        ...
        <!-- Team Start -->
        <div class="team-section section-padding-01">
            <div class="container custom-container">

                <div class="row">
                    <div class="col-md-6">
                        <div class="section-title" data-aos="fade-up" data-aos-duration="1000">
                            <h2 class="section-title__title"><?=$join_team_title[0]?> <mark> <?=$join_team_title[1]?> </mark></h2>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="section-btn-02 text-md-end" data-aos="fade-up" data-aos-duration="1000">
                            <a class="btn btn-primary btn-hover-secondary display_instructor_signup_modal" href="javascript:void(0);">Join Instructor Team</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <?php foreach($insData as $index => $instructor){ ?> 
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <!-- Team Item Start -->
                            <div class="team-item aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                                <div class="team-item__image">

                                    <?php if (@$instructor->profilePic && file_exists('./uploads/users/'.@$instructor->profilePic)) { ?>
                                        <img src="<?= base_url('uploads/users/'.@$instructor->profilePic) ?>" alt="Instructor image" style="width: 270px;height: 188px;">
                                    <?php } else { ?>
                                        <img src="<?= base_url('dist/images/noimage.jpg') ?>" alt="Instructor image" style="width: 270px;height: 188px;">
                                    <?php } ?>
                                ...
                                <div class="dashboard-course-item__rating text-center mt-3">
                                    <div class="rating-star">
                                        <div class="rating-label" style="width: 80%;"></div>
                                    </div>
                                </div>
                                <div class="team-item__content" style="padding-top:0px;">
                                    <h3 class="team-item__name"><a href="><?=base_url()?>"><?=$instructor->firstName." ".$instructor->lastName?></a></h3>
                                    <!--<p class="team-item__position">President &amp; CEO</p>-->
                                </div>
                            </div>
                            <!-- Team Item End -->
                        </div>
