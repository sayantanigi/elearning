...
<div class="dashboard-content">
  <div class="container">
     <nav aria-label="breadcrumb">
      ...
      <form action="<?= base_url('instructor/chapter/update') ?>" class="needs-validation" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-6">
                <div class="dashboard-content-box">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-12">
                          ...
                          <input type="text" name="chapterName" id="chapterName" value="<?=$data->chapterName?>" class="form-control" required>
                        ...
                        <div class="col-md-12">
                          ...
                          <input type="number" name="totalHours" id="totalHours" value="<?=$data->totalHours?>" class="form-control" required>
                        </div>

                        <div class="col-md-12">
                          <label class="form-label-02">Chapter Cost (In USD)<span style="color:red;"> *</span></label>
                          <input type="number" name="cost" id="cost" value="<?=$data->cost?>" class="form-control" required>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="dashboard-content-box">
                    ...
                    <div id="dashboard-profile-cover-photo-editor" class="dashboard-settings-profile" style="height:250px;">
                            <input id="dashboard-photo-dialogue-box" class="dashboard-settings-profile__input test" type="file" name="image" accept=".png,.jpg,.jpeg" <?=(!empty($oldChapterPic)?'':'required')?> />
                            ...
                            <input type="hidden" name="oldChapterPic" value="<?=(!empty($oldChapterPic)?$oldChapterPic:null)?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 mt-3">
               <div class="dashboard-content-box">
                ...
                <div class="dashboard-settings__btn">
                    <button type="submit" class="btn btn-primary btn-hover-secondary">Update Chapter</button>
