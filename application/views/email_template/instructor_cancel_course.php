                                ...
                                <tr>
                                    <td style="padding: 45px;">
                                        <div class="f-fallback">
                                            ...
                                            <p style="font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;">Instructor, {instructor_name} has submit a request to cancel course, '{course_name}' ( {course_level} ). Click the button below to view the request details in your admin panel:</p>
                                        </div>
