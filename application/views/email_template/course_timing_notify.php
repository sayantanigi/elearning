                                ...
                                <tr>
                                    <td style="padding: 45px;">
                                        <div class="f-fallback">
                                            <h3 style="color: rgb(0, 0, 0); margin-top: 0; font-family: Nunito Sans, Helvetica, Arial, sans-serif;">Dear, {student_name}!</h3>
                                            <p style="font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;">Instructor, {instructor_name} has updated their schedule and due to which your class on {class_date} in '{course_name}' ( {course_level} ) will be held at {new_from_time} to {new_to_time} instead of {current_from_time} to {current_end_time}.</p>
                                        </div>
