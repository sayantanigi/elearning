                                ...
                                <tr>
                                    <td style="padding: 45px;">
                                        <div class="f-fallback">
                                            <h3 style="color: rgb(0, 0, 0); margin-top: 0; font-family: Nunito Sans, Helvetica, Arial, sans-serif;">Dear, Admin!</h3>
                                            <p style="font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;">Instructor, {instructor_name} has submit a request to cancel student {student_name} in course, '{course_name}' ( {course_level} ). Click the button below to view the request details in your admin panel:</p>
                                        </div>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{admin_url}" style="background-color: #3869D4;
                                                                ...
                                                                box-sizing: border-box;font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;" target="_blank">View The Request</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
