                                ...
                                <tr>
                                    <td style="padding: 45px;">
                                        <div class="f-fallback">
                                            <h3 style="color: rgb(0, 0, 0); margin-top: 0; font-family: Nunito Sans, Helvetica, Arial, sans-serif;">Dear, Instructor!</h3>
                                            <p style="font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;">Student, {student_name} has booked a class on their course, '{course_name}' ( {course_level} ). Click the button below to view your schedule on your panel:</p>
                                        </div>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{instructor_url}" style="background-color: #3869D4;
                                                                ...
                                                                box-sizing: border-box;font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;" target="_blank">View Schedule</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
