                                ...
                                <tr>
                                    <td style="padding: 45px;">
                                        <div class="f-fallback">
                                            <h3 style="color: rgb(0, 0, 0); margin-top: 0; font-family: Nunito Sans, Helvetica, Arial, sans-serif;">Dear, {instructor_name}!</h3>
                                            <p style="font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;">Student, {student_name} had a class on {class_date} in '{course_name}' ( {course_level} ) which would be held at {from_time} to {to_time} has been cancelled. You can manage your schedule accordingly.</p>
                                        </div>
