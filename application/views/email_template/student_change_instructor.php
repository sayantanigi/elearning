                                ...
                                <tr>
                                    <td style="padding: 45px;">
                                        <div class="f-fallback">
                                            ...
                                            <p style="font-family: Nunito Sans, Helvetica, Arial, sans-serif;font-size: 15px;">Student, {student_name} has submit a request to change their instructor, {instructor_name} in '{course_name}' ( {course_level} ). Click the button below to view the request details in your admin panel:</p>
                                        </div>
