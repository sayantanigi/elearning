        ...
        <div class="container">
            ...
            <div class="dashboard-settings">
                <div class="dashboard-tabs-menu">
                    <ul>
                        <li><a href="<?=base_url('student/settings')?>">Profile</a></li>
                        <li><a class="active" href="<?=base_url('student/reset')?>">Reset Password</a></li>
                    </ul>
                </div>
                <form action="<?=base_url('student/change_password')?>" method="post">
                    <div class="row">  
